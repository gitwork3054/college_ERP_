...
document.querySelectorAll('.record-row').forEach(row=>row.addEventListener('click',()=>{
  ...
  if(archived)html+=detailRow('Archive Reason',t(currentRecord.archive_reason))+detailRow('Archived On',currentRecord.archived_at||t('Not recorded'));
  ...
  document.querySelector('#detail-modal .admin-update')?.classList.toggle('archive-readonly',archived);
